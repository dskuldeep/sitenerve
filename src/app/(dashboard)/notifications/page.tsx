...
export default function GlobalNotificationsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Notifications"
        description="All notifications across your projects"
      >
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description={
            typeFilter === "all"
              ? "Notifications from all your projects will appear here"
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2 mt-1.5">
                  {notification.project?.name && (
                    <Badge
                      variant="secondary"
                      className="text-[10px] bg-blue-500/10 text-blue-400 border border-blue-500/20 px-1.5 py-0"
                    >
                      {notification.project.name}
                    </Badge>
                  )}
